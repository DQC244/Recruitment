  ...
  return (
    <Stack direction="row" pl={37.5} spacing={3}>
      ...
      {accountInfo.company ? (
        ...
        <Stack justifyContent="center" alignItems="center" flex={1} pt={10}>
          <AppTypography variant="h4">You don't have a company</AppTypography>
          <Button href={PathConstant.CREATE_COMPANY} variant="contained">Create now!</Button>
        </Stack>
      )}
      <Snackbar
        open={isOpenMsg}
